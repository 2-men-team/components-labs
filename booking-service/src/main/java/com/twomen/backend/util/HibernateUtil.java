...
public class HibernateUtil {
  ...
  public static SessionFactory getSessionFactory() {
    if (sessionFactory == null) {
      ...
      properties.put(Environment.URL, "jdbc:mysql://bookingdb:3306/booking_service?allowPublicKeyRetrieval=true&useSSL=false");
      properties.put(Environment.USER, "vasniktel");
      properties.put(Environment.PASS, "vasniktel");
